...
public class TuteeSearch extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tutee_search);
        ...
        btnPre.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                Intent BackIntent = new Intent(TuteeSearch.this,UserSpace.class);
                BackIntent.putExtra("user_id",U_id);
                BackIntent.putExtra("UserName",UserName);
                TuteeSearch.this.startActivity(BackIntent);
            }
        });
    ...
    private void Search(String subject) {
            ...
            public void onResponse(String response) {
                try {
                    ...
                    if(!success){
                        ...
                        ListAdapter adapter = new ArrayAdapter<ArrayList>(TuteeSearch.this,android.R.layout.simple_list_item_1,datalist);
                        list_results.setAdapter(adapter);
                    }
                    else{
                        AlertDialog.Builder builder = new AlertDialog.Builder(TuteeSearch.this);
        ...
        TuteeSearchRequest searchRequest = new TuteeSearchRequest(subject, responselistener);
        RequestQueue queue = Volley.newRequestQueue(TuteeSearch.this);
        queue.add(searchRequest);
    }

    @Override
    public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
        Intent intent = new Intent(TuteeSearch.this,TuteeResultDetail.class);
        ArrayList<String> list = ( ArrayList<String>)(list_results).getItemAtPosition(i);
        intent.putExtra("U_id",U_id);
        intent.putExtra("UserName",UserName);
        intent.putStringArrayListExtra("list",list);
        TuteeSearch.this.startActivity(intent);
    }
