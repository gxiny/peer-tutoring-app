...
public class TuteeCreate extends AppCompatActivity implements View.OnClickListener{
    ...
    public void datePic(){
        ...
        DatePickerDialog datePickerDialog=new DatePickerDialog(TuteeCreate.this, new DatePickerDialog.OnDateSetListener() {
            @Override
    ...
    public void timePic(){
        ...
        TimePickerDialog timePickerDialog=new TimePickerDialog(TuteeCreate.this, new TimePickerDialog.OnTimeSetListener() {
            @Override
